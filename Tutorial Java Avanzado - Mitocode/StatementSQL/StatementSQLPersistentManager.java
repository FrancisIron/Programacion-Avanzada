...
public class StatementSQLPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "StatementSQL";
	...
	private StatementSQLPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new StatementSQLPersistentManager();
		}
